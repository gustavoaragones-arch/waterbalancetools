...
This audit crawled and parsed the *actual generated HTML* of the WaterBalanceTools repository as it exists on disk at commit `2e5c0948d5fc6298b02ce5bac4b434fd5ea400ed` -- not the source templates, and not prior phase reports. It found **522 HTML files**, of which **522** are indexable-candidate pages (the remainder are template sources and partial includes, which were excluded from the walk itself).
...
Distribution: 0-1: 0, 1-2: 296, 2-3: 226

Full scores + per-dimension evidence: `content-quality.csv`, `content-quality.json`.

## 4. Programmatic Content Findings

- **programmatic/shock** (7 pages): risk **HIGH**, avg pairwise similarity 0.715, 15 high-similarity pairs, 25 repeated paragraph blocks, 3 repeated FAQ entries, 0 repeated tables.
...
- **calculators** (15 pages): risk **MEDIUM**, avg pairwise similarity 0.272, 0 high-similarity pairs, 5 repeated paragraph blocks, 0 repeated FAQ entries, 0 repeated tables.
...
0 CRITICAL, 0 HIGH, 34 MEDIUM risk pairs identified among calculator/chart/guide/programmatic/reference pages sharing a core intent.
