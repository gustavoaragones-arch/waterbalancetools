...
Orphan pages (0 inbound internal links, excluding homepage): **2**. Inbound-link distribution: {"0":2,"1-2":137,"3-4":60,"5+":325}. Full graph: `internal-link-audit.csv`, `internal-link-graph.json`.
