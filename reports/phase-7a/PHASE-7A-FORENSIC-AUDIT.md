...
This audit crawled and parsed the *actual generated HTML* of the WaterBalanceTools repository as it exists on disk at commit `6df374b4b10e832503791d8f5286218806828a2c` -- not the source templates, and not prior phase reports. It found **522 HTML files**, of which **522** are indexable-candidate pages (the remainder are template sources and partial includes, which were excluded from the walk itself).
...
2. **Zero external sources sitewide.** Across 413 major factual pages, **413** cite zero external authoritative sources (0 `<a href>` tags anywhere in the crawled HTML point off waterbalancetools.com). The `.knowledge-sources` block present on 256 pages contains only a "Last reviewed: DATE" stamp, not a citation.
...
| Metric | Value |
|---|---|
| Total HTML files discovered (indexable-candidate walk) | 522 |
| Indexable-candidate pages | 522 |
...
| Pages with `lang="en"` | 522 / 522 |
| Sitemap URL count (8 sitemap files) | 478 |
| `_redirects` rules | 28 |
...
Average `overall_quality_score` (0-3 scale, 10-dimension rubric, see Deliverable 2 methodology) across all 522 pages: **1.90 / 3**.

Distribution: 0-1: 0, 1-2: 295, 2-3: 227

Full scores + per-dimension evidence: `content-quality.csv`, `content-quality.json`.

## 4. Programmatic Content Findings

- **programmatic/hot-tubs** (6 pages): risk **HIGH**, avg pairwise similarity 0.711, 10 high-similarity pairs, 25 repeated paragraph blocks, 3 repeated FAQ entries, 0 repeated tables.
- **programmatic/shock** (7 pages): risk **HIGH**, avg pairwise similarity 0.689, 15 high-similarity pairs, 23 repeated paragraph blocks, 3 repeated FAQ entries, 0 repeated tables.
- **programmatic/chlorine** (12 pages): risk **HIGH**, avg pairwise similarity 0.651, 55 high-similarity pairs, 26 repeated paragraph blocks, 3 repeated FAQ entries, 0 repeated tables.
- **programmatic/ph** (5 pages): risk **HIGH**, avg pairwise similarity 0.579, 5 high-similarity pairs, 31 repeated paragraph blocks, 5 repeated FAQ entries, 1 repeated tables.
...
- **calculators** (15 pages): risk **MEDIUM**, avg pairwise similarity 0.279, 0 high-similarity pairs, 4 repeated paragraph blocks, 0 repeated FAQ entries, 0 repeated tables.
- **reports** (13 pages): risk **MEDIUM**, avg pairwise similarity 0.262, 0 high-similarity pairs, 1 repeated paragraph blocks, 0 repeated FAQ entries, 3 repeated tables.
- **guides** (7 pages): risk **LOW**, avg pairwise similarity 0.227, 0 high-similarity pairs, 4 repeated paragraph blocks, 0 repeated FAQ entries, 0 repeated tables.
- **entities** (105 pages): risk **LOW**, avg pairwise similarity 0.225, 1 high-similarity pairs, 46 repeated paragraph blocks, 0 repeated FAQ entries, 0 repeated tables.
...
- **academy/fundamentals** (7 pages): risk **LOW**, avg pairwise similarity 0, 0 high-similarity pairs, 4 repeated paragraph blocks, 0 repeated FAQ entries, 0 repeated tables.
...
- **guides/edge-cases** (6 pages): risk **LOW**, avg pairwise similarity 0, 0 high-similarity pairs, 2 repeated paragraph blocks, 0 repeated FAQ entries, 0 repeated tables.
...
3955 candidate chemistry claims (sentences containing a tracked chemistry term and/or a numeric range/unit) were extracted across 522 pages. This audit did **not** independently verify chemistry correctness against external literature -- per the audit brief, uncertain content is flagged `REQUIRES_EXPERT_REVIEW` rather than silently corrected or judged.
...
- **general**: 80 distinct range/unit strings found -- `1ppm | 3ppm | 85ppm | 100% | 65–80% | 70°f | 3–5ppm | 98–104°f | 80°f | 1–3ppm | 5ppm | 30–50ppm | 0.8ppm | 2.5ppm | 2ppm | 500ppm | 100–104°f | 80–100ppm | 150ppm | 70% | 10–12.5% | 0.6ppm | 0.5ppm | 100ppm | 90ppm | 3.5ppm | 1.5ppm | 8ppm | 4ppm | 400ppm | 10ppm | 80ppm | 90% | 90°f | 80–120ppm | 0–0ppm | 0ppm | 30–100ppm | 0.5–1ppm | 000ppm | 40ppm | 6ppm | 30-50ppm | 10% | 1-3ppm | 65% | 200–400ppm | 150–250ppm | 56% | 0.2ppm | 30ppm | 60–90% | 25% | 50% | 6.7ppm | 10–20% | 0.5–1.0ppm | 50–80% | 78–84°f | 32°f | 20ppm | 15–20% | 2–3ppm | 4–5ppm | 120ppm | 80–90ppm | 77°f | 104°f | 10–15% | 2.00ppm | 60–80ppm | 20–30% | 1mg/l | 1500ppm | 78–82°f | 77–79°f | 82–84°f | 50°f | 1000ppm | 73%`
- **ph**: 54 distinct range/unit strings found -- `80–100ppm | 10°f | 68°f | 22% | 80–120ppm | 3ppm | 3–5ppm | 2ppm | 10–12.5% | 0.5ppm | 10ppm | 0.8ppm | 100ppm | 250ppm | 480ppm | 90ppm | 2.5ppm | 30ppm | 55% | 28% | 120ppm | 60ppm | 50ppm | 10% | 1–3ppm | 100–104°f | 10–12% | 60–80ppm | 30–50ppm | 80°f | 100% | 31.5% | 150ppm | 20–30ppm | 67% | 31.45% | 93.2% | 200ppm | 20% | 31% | 80–90ppm | 10–20% | 5ppm | 1ppm | 60% | 0.2ppm | 0.05ppm | 500ppm | 77°f | 90% | 50% | 104°f | 85°f | 400ppm`
- **free chlorine**: 35 distinct range/unit strings found -- `1–3ppm | 3ppm | 5ppm | 67% | 1.0ppm | 0.5ppm | 0.9ppm | 2.0ppm | 1ppm | 22% | 10–30ppm | 1-3ppm | 3–5ppm | 3–6ppm | 65% | 0–0ppm | 30–50ppm | 30–100ppm | 0.5–1ppm | 400ppm | 78–84°f | 10% | 30ppm | 5–15ppm | 65–73% | 0ppm | 56% | 6.5ppm | 10ppm | 90% | 0.5–1.0ppm | 85–90°f | 60% | 80–120ppm | 75–90%`
- **shock**: 26 distinct range/unit strings found -- `0.5ppm | 65–73% | 10ppm | 30ppm | 10% | 5ppm | 10–30ppm | 1–3ppm | 65% | 56–62% | 20–30ppm | 5–15ppm | 0ppm | 0.2ppm | 6.5ppm | 10–12.5% | 60°f | 1ppm | 30–50ppm | 3–5ppm | 100ppm | 10–20ppm | 8–15ppm | 85°f | 50ppm | 10–15ppm`
- **salt**: 19 distinct range/unit strings found -- `400ppm | 60–80ppm | 300ppm | 750ppm | 99.8% | 000ppm | 200ppm | 800ppm | 12ppm | 1–3ppm | 500ppm | 30–50ppm | 100ppm | 30% | 10% | 73% | 31.45% | 100% | 3200ppm`
...
- **calcium hardness**: 11 distinct range/unit strings found -- `80–120ppm | 200–400ppm | 150ppm | 80–100ppm | 400ppm | 500ppm | 60–70% | 3–5ppm | 300ppm | 77% | 80ppm`
...
0 CRITICAL, 0 HIGH, 39 MEDIUM risk pairs identified among calculator/chart/guide/programmatic/reference pages sharing a core intent.
...
86 / 522 pages score LIKELY on "AI-answerable using only this page" (answer-first block + FAQ/quick-answer + sufficient semantic completeness). Full data: `aeo-audit.csv`.

## 8. E-E-A-T Findings

Missing sitewide: named_author_or_reviewer. Zero pages sitewide (0/522) carry a named author or reviewer byline. Full detail: `trust-audit.md`, `trust-audit.json`.

## 9. Structured Data Findings

Schema status counts across all JSON-LD blocks found: VALID: 856, QUESTIONABLE: 49, MISSING: 63. The MISREPRESENTED count is driven almost entirely by the `{{H1_TITLE}}` template-leakage defect (see Executive Summary). Full data: `schema-audit.csv`.

## 10. Internal Linking Findings

Orphan pages (0 inbound internal links, excluding homepage): **2**. Inbound-link distribution: {"0":2,"1-2":139,"3-4":58,"5+":323}. Full graph: `internal-link-audit.csv`, `internal-link-graph.json`.
...
Sitemap contains 478 URLs against 522 discovered pages -- the -44 difference should be reconciled (either stale sitemap entries for removed pages, or a URL-form mismatch this crawl's resolver did not catch; see Audit Limitations). Full data: `crawl-indexation-audit.csv`.
...
26 / 522 pages flagged at least one static accessibility issue (missing alt text, missing viewport meta, heading-level skip, unlabeled calculator form, or a table without `<th>` headers). Full data: `ux-accessibility-audit.csv`.
...
- 413 of 413 factual pages cite zero external sources -- translating unverifiable claims multiplies the accuracy-review burden per locale.
- 4 programmatic page families show HIGH/CRITICAL near-duplicate content -- translating near-duplicates multiplies thin/duplicate-content risk per locale rather than fixing it once.
...
Action counts: IMPROVE: 174, UNCHANGED: 250, KEEP: 70, MERGE: 28. Full matrix: `action-matrix.csv`, `action-matrix.json`.
...
- `entities/fiberglass-pool.html`: originality_score=1 (near-duplicate of a sibling page's body text) -- see programmatic-duplication.csv for family "entities".
- `entities/vinyl-pool.html`: originality_score=1 (near-duplicate of a sibling page's body text) -- see programmatic-duplication.csv for family "entities".
...
...and 20 more; see `action-matrix.csv` filtered to priority=P1.
...
- `entities/biguanide.html`: word_count=114 -- thin content risk for AdSense/quality.

...and 89 more; see `action-matrix.csv` filtered to priority=P2.

## 19. P3 Findings (399)

Enhancement-tier only; see `action-matrix.csv` filtered to priority=P3 for the full list (399 rows).
...
3. Decide the fate of the 4 HIGH/CRITICAL-risk programmatic families (`hot-tubs`, `shock`, `chlorine`, `ph`) -- likely differentiation work (more unique per-page data/examples) rather than deletion, since page_count per family is modest (5-12).
...
- The sitemap/inventory count gap (478 vs 522) was flagged but not root-caused in this pass -- see Roadmap item 7.
- Cannibalization analysis focused on calculator/chart/guide/programmatic/reference/comparison/academy page types and a fixed list of 16 core intent phrases; it is not an exhaustive pairwise comparison of all 522 pages (that would be ~136k comparisons) and may miss cannibalization on intents outside that list.

## 24. Files and Scripts Examined

- All 522 `*.html` files under the repository root (excluding `node_modules`, `.git`, and this audit's own `reports/phase-7a/` output).
