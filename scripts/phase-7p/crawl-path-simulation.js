...
'use strict';
/**
 * crawl-path-simulation.js (Phase 7P, Step 20)
...
fs.writeFileSync(path.join(ROOT, 'reports', 'phase-7p', 'CRAWL-PATH-SIMULATION.json'), JSON.stringify(summary, null, 2));

const md = `# Phase 7P — Crawl Path Simulation
...
`;
fs.writeFileSync(path.join(ROOT, 'reports', 'phase-7p', 'CRAWL-PATH-SIMULATION.md'), md);
